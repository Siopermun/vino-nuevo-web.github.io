...
var init_chunk_EPOLDU6W = __esm({
  "node_modules/react-router/dist/development/chunk-EPOLDU6W.mjs"() {
    ...
    defaultErrorElement = React2.createElement(DefaultErrorComponent, null);
    ...
    AwaitErrorBoundary = class extends React3.Component {
      constructor(props) {
        super(props);
    ...
    NO_BODY_STATUS_CODES = /* @__PURE__ */ new Set([100, 101, 204, 205]);
    ...
    isHydrated = false;
    RemixErrorBoundary = class extends React9.Component {
      constructor(props) {
        super(props);
...
var init_chunk_FNSCYPCZ = __esm({
  "node_modules/react-router/dist/development/chunk-FNSCYPCZ.mjs"() {
    ...
    createKey2 = async (secret, usages) => crypto.subtle.importKey(
      "raw",
    ...
    SERVER_NO_BODY_STATUS_CODES = /* @__PURE__ */ new Set([
    ...
    trailer = "</body></html>";
    RSCRouterGlobalErrorBoundary = class extends import_react.default.Component {
      constructor(props) {
        super(props);
...
function RSCHydratedRouter({
  ...
  if (payload.type !== "render")
    throw new Error("Invalid payload type");
  let { router: router2, routeModules } = React33.useMemo(
  ...
  let [{ routes, state }, setState] = React33.useState(() => ({
  ...
  const transitionEnabledRouter = React33.useMemo(
    () => ({
      ...router2,
      state,
      routes
  ...
  return React33.createElement(RSCRouterContext.Provider, { value: true }, React33.createElement(RSCRouterGlobalErrorBoundary, { location: state.location }, React33.createElement(FrameworkContext.Provider, { value: frameworkContext }, React33.createElement(
    RouterProvider,
    {
...
function diffRoutes(a, b) {
  ...
  return a.some((route, index) => {
    if (route.element !== b[index].element)
      return true;
    ...
    if (route.hasErrorBoundary !== b[index].hasErrorBoundary)
      return true;
    if (route.hasLoader !== b[index].hasLoader)
      return true;
    if (route.hasClientLoader !== b[index].hasClientLoader)
      return true;
    if (route.hasAction !== b[index].hasAction)
      return true;
...
var React13, ReactDOM, React23, React33, ReactDOM2, ssrInfo, router, renderedRoutesContext, nextPaths2, discoveredPathsMaxSize2, discoveredPaths2, URL_LIMIT2;
var init_dom_export = __esm({
  "node_modules/react-router/dist/development/dom-export.mjs"() {
    ...
    ssrInfo = null;
    router = null;
    renderedRoutesContext = createContext4();
...
react-router/dist/development/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EI3L3XW6.js.map
